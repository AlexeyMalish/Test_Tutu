...
import com.medicineappstudio.covid19statics.model.CountryModel;
import com.medicineappstudio.covid19statics.view.adapter.CountryAdapter;
        ...
        StringRequest request =new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response)
            {
                try {
                    ...
                    myCustomAdapter=new CountryAdapter(AffectedCountries.this,countryModelList);
